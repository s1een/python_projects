...
class ScoreBoard:
    ...
    def __init__(self, ai_game):
        ...
        self.text_color_score = (255, 255, 255)
        self.text_color_record = (235, 184, 61)
        self.text_color_level = (235, 184, 61)
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(high_score_str, True, self.text_color_record)
